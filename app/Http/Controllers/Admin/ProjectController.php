...
class ProjectController extends Controller
{
    public function index()
    {
        ...
        return view('admin.projects.index', compact('clients', 'project_categories', 'project_statuses', 'projects', 'teams'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.projects.create', compact('categories', 'clients', 'statuses'));
    }
    ...
    public function edit(Project $project)
    {
        ...
        return view('admin.projects.edit', compact('categories', 'clients', 'project', 'statuses'));
    }
